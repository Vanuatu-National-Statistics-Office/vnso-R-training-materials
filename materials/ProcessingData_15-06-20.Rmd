...
# Remove extreme or outlier values
boxplot.stats(mergedMotorCarTrendsWithoutDuplicates$HorsePower) #identifies outlier values 
...
mergedMotorCarTrendsWithoutDuplicates$AgeCategories <- cut(mergedMotorCarTrendsWithoutDuplicates$AgeOfBuyer, breaks=ageCuts)
```
